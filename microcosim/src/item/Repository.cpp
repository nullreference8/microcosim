...
namespace Item {
  ...
  std::shared_ptr<std::vector<Item::ItemIdentifier>> Repository::SelectAllIdentifier() {
    ...
    std::vector<Item::ItemIdentifier> identifiers;
    int rc = 0;
    ...
    auto res = std::make_shared<std::vector<Item::ItemIdentifier>>(identifiers);
    return res;
  }

  std::shared_ptr<std::vector<Item::ItemIdentifier>> Repository::SelectFamilies() {
    sqlite3* db;
    sqlite3_stmt* stmt;
  ...
  std::shared_ptr<std::vector<Item::ItemIdentifier>> Repository::SelectOrders(Item::ItemIdentifier identifier) {
    sqlite3* db;
    sqlite3_stmt* stmt;
  ...
  std::shared_ptr<std::vector<Item::ItemIdentifier>> Repository::SelectType(Item::ItemIdentifier identifier) {
    sqlite3* db;
    sqlite3_stmt* stmt;
  ...
  std::shared_ptr<std::vector<Item::ItemIdentifier>> Repository::SelectForm(Item::ItemIdentifier identifier) {
    sqlite3* db;
    sqlite3_stmt* stmt;
